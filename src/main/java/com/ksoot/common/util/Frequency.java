...
@ApiModel(value = "frequency", description = "Time interval to update rate from rate providers. Madatory only for NON-MANUAL rate providers")
public class Frequency {

    @Size(min = 0)
    @ApiModelProperty(name = "hours", value = "Hours", example = "23", position = 1)
    private long hours;

    @Size(min = 0, max = 59)
    @ApiModelProperty(name = "minutes", value = "Minutes", example = "59", position = 2)
    private long minutes;

    @Size(min = 0, max = 59)
    @ApiModelProperty(name = "seconds", value = "Seconds", example = "45", position = 3)
    private long seconds;

    @Size(min = 0, max = 999)
    @ApiModelProperty(name = "milliSeconds", value = "Milli seconds", example = "678", position = 4)
